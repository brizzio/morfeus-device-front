var initialized = false;
		document.addEventListener("DOMContentLoaded", button_callback)
			...
			var processfn = function(video, dt) {
				...
				for(i=0; i<dets.length; ++i)
					...
					if(dets[i][3]>50.0)
					{
                        ...
                        console.log('leu essa' + idx++)
                        var idata=ctx.getImageData(x,y,2*r,2*r).data;
                        
                        // Create canvas element
                        // var can_vas = document.createElement('canvas');
                        // var ct_x = can_vas.getContext('2d');
                        // can_vas.width = idata.width;
                        // can_vas.height = idata.height;
                        // ct_x.putImageData(idata, 0, 0);
